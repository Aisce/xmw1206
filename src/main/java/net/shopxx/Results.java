 ...
 * FileId: ev1a1Q/07Fsyo3/Jw+4ZWdQ9LrLXVfxl
 */
package net.shopxx;
...
public final class Results {
	 ...
	 * 导航组删除状态消息
	 */
	public static final String DEFAULT_UNPROCESSABLE_ENTITY_MESSAGE1 = "common.message.unprocessableEntity1";
	 ...
	 * 422状态ResponseEntity
	 */
	public static final ResponseEntity<Map<String, String>> UNPROCESSABLE_ENTITY1 = Results.unprocessableEntity(DEFAULT_UNPROCESSABLE_ENTITY_MESSAGE1);
