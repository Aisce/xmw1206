...
public class ProductController extends BaseController {
	 ...
	 */
	@GetMapping("/list")
	public String list(Product.Type type, Long productCategoryId, Long brandId, Long productTagId, Boolean isFine, Boolean isActive, Boolean isMarketable, Boolean isList, Boolean isTop, Boolean isOutOfStock, Boolean isHot, Boolean isStockAlert, Pageable pageable, ModelMap model) {
		...
		model.addAttribute("page", productService.findPage(type, null, null, productCategory, null, brand, null, productTag, null, null, null, null, null, isMarketable, isList, isTop, isFine, isActive, isOutOfStock, isStockAlert, null, null, pageable, isHot));
