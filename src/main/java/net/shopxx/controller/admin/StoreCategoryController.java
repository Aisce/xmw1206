 ...
 * FileId: JBSdij7IPagnjwmEe4Ezc86Ln02dA+TR
 */
...
public class StoreCategoryController extends BaseController {
	...
	public @ResponseBody boolean checkCode(String code) {
		return StringUtils.isNotEmpty(code) && !storeCategoryService.codeExists(code);
	}
