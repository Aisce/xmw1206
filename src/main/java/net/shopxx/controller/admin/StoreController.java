...
public class StoreController extends BaseController {
	 ...
	 */
	@GetMapping("/list")
	public String list(Store.Type type, Store.Status status, Boolean isFine, Boolean isEnabled, Boolean hasExpired, Pageable pageable, ModelMap model) {
		model.addAttribute("type", type);
		model.addAttribute("status", status);
		model.addAttribute("isFine", isFine);
		model.addAttribute("isEnabled", isEnabled);
		model.addAttribute("hasExpired", hasExpired);
		model.addAttribute("page", storeService.findPage(type, status, isFine, isEnabled, hasExpired, pageable));
