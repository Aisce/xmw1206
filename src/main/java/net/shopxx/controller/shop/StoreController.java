 ...
 * FileId: ksrkAcxNrpCrcDd1BgZm+qfUiTcbeujB
 */
...
public class StoreController extends BaseController {
	...
	public String findAllStore(Store store,ModelMap model,Pageable pageable,Long storeCategoryId,String name) {
		Page<Store> findPage = storeService.findPage(Store.Type.GENERAL, Store.Status.SUCCESS, null, true, null, pageable,storeCategoryId,name);
		List<StoreCategory> findAll = storeCategoryService.findAll();
