 ...
 * FileId: sTVe52LrNclhHuvuXloBV0vg5biHhT08
 */
...
public interface ProductDao extends BaseDao<Product, Long> {
	...
	List<Product> findList(Product entity,Product.Type type, Store store, ProductCategory productCategory, StoreProductCategory storeProductCategory, Brand brand, Promotion promotion, ProductTag productTag, StoreProductTag storeProductTag, Map<Attribute, String> attributeValueMap, BigDecimal startPrice,
			BigDecimal endPrice, Boolean isMarketable, Boolean isList, Boolean isTop, Boolean isActive, Boolean isOutOfStock, Boolean isStockAlert, Boolean hasPromotion, Product.OrderType orderType, Integer count, List<Filter> filters, List<Order> orders);
	/**
	 * 查找商品
	 * 
	 ...
	 * 以店铺和隐藏编号查询数据
	 */
	List<Product> findByCopySn(Store currentStore,String copySn);

	Page<Product> findPage(Pageable pageable, Boolean isSample,Boolean isActive,Boolean isMarketable);
