 ...
 * FileId: 2zvfBxZ9iWAg9eOQJCgsYGA0mjZNUV/n
 */
...
public interface StoreProductCategoryDao extends BaseDao<StoreProductCategory, Long> {
	...
	void saveStoreProductCategory(StoreProductCategory storeProductCategory) ;

	List<StoreProductCategory> findname(StoreProductCategory storeProductCategory, Store store, boolean recursive,
			Integer count);
}