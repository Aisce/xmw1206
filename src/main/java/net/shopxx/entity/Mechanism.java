 ...
 */
@Entity
public class Mechanism extends User {
	...
	static {
		...
		RESTRICT_BUSINESS_PERMISSIONS.add("mechanism:index");
		RESTRICT_BUSINESS_PERMISSIONS.add("mechanism:storeRegister");
		RESTRICT_BUSINESS_PERMISSIONS.add("mechanism:storePayment");
		RESTRICT_BUSINESS_PERMISSIONS.add("mechanism:storeReapply");

		NORMAL_BUSINESS_PERMISSIONS.add("mechanism:index");
		NORMAL_BUSINESS_PERMISSIONS.add("mechanism:product");
		NORMAL_BUSINESS_PERMISSIONS.add("mechanism:stock");
		NORMAL_BUSINESS_PERMISSIONS.add("mechanism:productNotify");
		NORMAL_BUSINESS_PERMISSIONS.add("mechanism:consultation");
		NORMAL_BUSINESS_PERMISSIONS.add("mechanism:review");
		NORMAL_BUSINESS_PERMISSIONS.add("mechanism:order");
		NORMAL_BUSINESS_PERMISSIONS.add("mechanism:print");
		NORMAL_BUSINESS_PERMISSIONS.add("mechanism:deliveryTemplate");
		NORMAL_BUSINESS_PERMISSIONS.add("mechanism:deliveryCenter");
		NORMAL_BUSINESS_PERMISSIONS.add("mechanism:aftersales");
		NORMAL_BUSINESS_PERMISSIONS.add("mechanism:storeSetting");
		NORMAL_BUSINESS_PERMISSIONS.add("mechanism:storeProductCategory");
		NORMAL_BUSINESS_PERMISSIONS.add("mechanism:storeProductTag");
		NORMAL_BUSINESS_PERMISSIONS.add("mechanism:categoryApplication");
		NORMAL_BUSINESS_PERMISSIONS.add("mechanism:storePayment");
		NORMAL_BUSINESS_PERMISSIONS.add("mechanism:shippingMethod");
		NORMAL_BUSINESS_PERMISSIONS.add("mechanism:areaFreightConfig");
		NORMAL_BUSINESS_PERMISSIONS.add("mechanism:storeAdImage");
		NORMAL_BUSINESS_PERMISSIONS.add("mechanism:aftersalesSetting");
		NORMAL_BUSINESS_PERMISSIONS.add("mechanism:promotionPlugin");
		NORMAL_BUSINESS_PERMISSIONS.add("mechanism:promotion");
		NORMAL_BUSINESS_PERMISSIONS.add("mechanism:coupon");
		NORMAL_BUSINESS_PERMISSIONS.add("mechanism:businessDeposit");
		NORMAL_BUSINESS_PERMISSIONS.add("mechanism:businessCash");
		NORMAL_BUSINESS_PERMISSIONS.add("mechanism:profile");
		NORMAL_BUSINESS_PERMISSIONS.add("mechanism:password");
		NORMAL_BUSINESS_PERMISSIONS.add("mechanism:message");
		NORMAL_BUSINESS_PERMISSIONS.add("mechanism:messageGroup");
		NORMAL_BUSINESS_PERMISSIONS.add("mechanism:instantMessage");
		NORMAL_BUSINESS_PERMISSIONS.add("mechanism:orderStatistic");
		NORMAL_BUSINESS_PERMISSIONS.add("mechanism:fundStatistic");
		NORMAL_BUSINESS_PERMISSIONS.add("mechanism:productRanking");
	}
	 ...
	 * @return 店铺
	 */
	public MechanismStore getStore() {
		return store;
	}
	 ...
	 *            店铺
	 */
	public void setStore(MechanismStore store) {
		this.store = store;
	}
