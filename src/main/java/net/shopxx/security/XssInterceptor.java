 ...
 * FileId: WNsoCCv6C6vCaLreX/Bd8rAqDEBf7YMk
 */
	...
	public enum WhitelistType {
		...
		private static Whitelist getRelaxedWhitelist() {
			return new Whitelist()
					...
					.addAttributes("a","style", "charset", "title", "coords", "download", "href", "hreflang", "media", "name", "rel", "rev", "shape", "target", "type").addAttributes("code", "object", "applet", "align", "alt", "archive", "codebase", "height", "hspace", "name", "vspace", "width")
					...
					.addAttributes("img", "title", "alt", "src", "_src", "align", "border", "height", "hspace", "ismap", "longdesc", "usemap", "vspace", "width")
					...
					.addAttributes("optgroup", "label", "disabled").addAttributes("option", "disabled", "label", "selected", "value").addAttributes("output", "for", "form", "name").addAttributes("p", "align", "style").addAttributes("param", "name", "type", "value", "valuetype").addAttributes("pre", "width")
