 ...
 * FileId: SMvCONUJ86DhHj7O8nzfcI/i/SjqMBtT
 */
...
public interface ProductCategoryService extends BaseService<ProductCategory, Long> {
	...
	List<ProductCategory> findInIds(String[] ids);
	List<ProductCategory> findname(ProductCategory storeProductCategory, Store store, boolean recursive, Integer count);
