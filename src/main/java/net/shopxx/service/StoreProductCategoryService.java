 ...
 * FileId: ONigew99kolb03TGcq2wB5BnK8LO2N53
 */
...
public interface StoreProductCategoryService extends BaseService<StoreProductCategory, Long> {
	 ...
	 * 添加所有厂家商品分类
	 */
	StoreProductCategory saveStoreProductCategory(ProductCategory productCategory,StoreProductCategory storeProductCategory);
	 List<StoreProductCategory> findName(StoreProductCategory storeProductCategory,Store store);
}