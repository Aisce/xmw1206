 ...
 * FileId: 3yPk11w8rz1tzJzhm73aTpoOwOP/NwWW
 */
...
public class CategoryApplicationServiceImpl extends BaseServiceImpl<CategoryApplication, Long> implements CategoryApplicationService {
	...
	@Override
	public void review1(Store store,ProductCategory productCategory) {
			Set<ProductCategory> productCategories2 = store.getProductCategories();
