 ...
 * FileId: RQbh3AsWa2khiHkAOgSMr7mN+XH+0379
 */
...
public class MemberServiceImpl extends BaseServiceImpl<Member, Long> implements MemberService {
	...
	@Override
	public boolean updateRealnameStatus(Member member) {
		Member pMember = find(member.getId());
		pMember.setAttestationFlag(member.getAttestationFlag());
		if (StringUtils.isNotBlank(member.getAttributeValue9())) {
			pMember.setAttributeValue9(member.getAttributeValue9());
		}
		return super.update(pMember) != null;
	}
