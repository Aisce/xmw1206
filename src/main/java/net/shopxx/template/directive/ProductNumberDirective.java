 ...
 */
@Component
public class ProductNumberDirective extends BaseDirective {
	 ...
	 * "编号数组"参数名称
	 */
	private static final String NUMBER_ARRAY_PARAMETER_NAME = "numbers";
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		String numbers = FreeMarkerUtils.getParameter(NUMBER_ARRAY_PARAMETER_NAME, String.class, params);
		...
		if(numbers != null){
			List<Product> products = productService.findList(numbers, orderType, count, filters, orders);
