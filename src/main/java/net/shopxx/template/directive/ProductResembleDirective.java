 ...
 * FileId: iF/VMNX3w4ksmY8N0JOYXYSVSN5RjI0h
 */
 ...
 */
@Component
public class ProductResembleDirective extends BaseDirective {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		Long productId = FreeMarkerUtils.getParameter(PRODUCT_ID, Long.class, params);
		...
		List<Product> products = productService.findList(productId,type, storeId, productCategoryId, storeProductCategoryId, brandId, promotionId, productTagId, storeProductTagId, attributeValueMap, startPrice, endPrice, true, true, null, true, null, null, hasPromotion, orderType, count, filters, orders,
				useCache);
