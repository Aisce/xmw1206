 ...
 * FileId: TVCEGmI63J5UslKyTNZqT3lwPQobmUxW
 */
 ...
 */
@Component
public class WikiCategoryChildrenListDirective extends BaseDirective {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		List<WikiCategory> wikiCategories = wikiCategoryService.findChildren(wikiCategoryId, recursive != null ? recursive : true, count, useCache);
