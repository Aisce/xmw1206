 ...
 * FileId: 2PhuGPZw1E3WfXcVgfw+G9sKNgjrrPqZ
 */
 ...
 */
@Component
public class WikiCategoryRootListDirective extends BaseDirective {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		List<WikiCategory> wikiCategories = wikiCategoryService.findRoots(count, useCache);
