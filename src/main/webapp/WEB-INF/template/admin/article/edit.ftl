...
<head>
	...
	<title>${message("admin.article.edit")} - 北京芯梦国际科技有限公司</title>
			...
			$().ready(function() {
				...
				$articleForm.validate({
					...
					submitHandler: function(form) {
						...
						$(form).ajaxSubmit({
							successRedirectUrl: "${base}/admin/article/list"
						});
					}
				});
				if (UE != null) {
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-10">
								...
								<textarea name="content" style="display:none;" id="ueditorHtml">${article.content}</textarea>
							</div>
						</div>
						<div class="form-group">
