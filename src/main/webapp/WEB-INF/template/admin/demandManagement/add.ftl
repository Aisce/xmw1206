				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-4">
								<label for="isTop"><input id="typeNorms1" name="typeNorms" class="form-control" type="radio" maxlength="200" value="0">${message("admin.demandManagement.type.research")}</label>
								<label for="isTop"><input id="typeNorms2" name="typeNorms" class="form-control" type="radio" maxlength="200" value="1">${message("admin.demandManagement.type.purchase")}</label>
							</div>
						</div>
						<!--需求数量-->
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-4">
								<input id="number" name="number" class="form-control" type="text" maxlength="200">
							</div>
						</div>
						<!--质量等级-->
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-4">
								<input id="demandUser" name="demandUser" class="form-control" type="text" maxlength="200">
							</div>
						</div>
						<!--需求简介-->
						<div class="form-group">
