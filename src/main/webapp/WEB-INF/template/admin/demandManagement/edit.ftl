...
<body class="admin">
	...
	<main>
		<div class="container-fluid">
			...
			<form id="articleForm" class="ajax-form form-horizontal" action="${base}/admin/demand_management/update" method="post">
				<input type="hidden" value="${DemandManagement.id}" name="id"/>
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-4">
								<input id="name" name="name" class="form-control" type="text" maxlength="200" value="${DemandManagement.name}">
							</div>
						</div>
						<!--需求类型-->
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-4">
								<label for="isTop"><input id="typeNorms1" name="typeNorms" class="form-control" type="radio" maxlength="200" value="0" [#if DemandManagement.typeNorms == 0]checked[/#if]>${message("admin.demandManagement.type.research")}</label>
								<label for="isTop"><input id="typeNorms2" name="typeNorms" class="form-control" type="radio" maxlength="200" value="1" [#if DemandManagement.typeNorms == 1]checked[/#if]>${message("admin.demandManagement.type.purchase")}</label>
							</div>
						</div>
						<!--需求数量-->
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-4">
								<input id="number" name="number" value="${DemandManagement.number}" class="form-control" type="text" maxlength="200">
							</div>
						</div>
						<!--质量等级-->
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-4">
								<input id="weight" name="weight" class="form-control" value="${DemandManagement.weight}" type="text" maxlength="200">
							</div>
						</div>
						<!--需求方-->
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-4">
								<input id="demandUser" name="demandUser" value="${DemandManagement.demandUser}" class="form-control" type="text" maxlength="200">
							</div>
						</div>
						<!--需求简介-->
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-4">
								<textarea id="synopsis" name="synopsis" class="form-control" row="4" >${DemandManagement.synopsis}</textarea>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-10">
								...
								<textarea name="introduction" style="display:none;" id="ueditorHtml">${DemandManagement.introduction}</textarea>
