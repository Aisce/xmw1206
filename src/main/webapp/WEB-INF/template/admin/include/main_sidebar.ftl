...
<aside id="mainSidebar" class="main-sidebar">
	...
	<div id="mainSidebarPanelGroup" class="panel-group">
		<div class="panel panel-default">
				...
				[#if hasPermission]
					<div class="panel-heading">
						<h4 class="panel-title">
							<a href="#storeGroupPanelCollapse" data-toggle="collapse" data-parent="#mainSidebarPanelGroup"[#if .main_template_name?matches("admin/index.*|admin/business/.*|admin/store/.*|admin/store_fine/.*|admin/store_category/.*|admin/store_rank/.*|admin/business_attribute/.*|admin/business_cash/.*|admin/category_application/.*|admin/business_deposit/.*")] aria-expanded="true"[/#if]>
			...
			<div id="storeGroupPanelCollapse" class="panel-collapse collapse[#if .main_template_name?matches("admin/index.*|admin/business/.*|admin/store/.*|admin/store_fine/.*|admin/store_category/.*|admin/store_rank/.*|admin/business_attribute/.*|admin/business_cash/.*|admin/category_application/.*|admin/business_deposit/.*")] in[/#if]">
				<div class="panel-body">
					<ul class="list-group">
						...
						[@has_permission_tag permission="admin:store"]
							[#if hasPermission]
								<li class="list-group-item[#if .main_template_name?matches("admin/store_fine/.*")] active[/#if]">
									<a href="${base}/admin/store_fine/list">
										<i class="iconfont icon-weixuanzhong"></i>
										${message("admin.mainSidebar.storeFine")}
									</a>
								</li>
							[/#if]
						[/@has_permission_tag]
		...
		<div class="panel panel-default">
			[@has_any_permissions_tag permissions = ["admin:business", "admin:store", "admin:storeCategory", "admin:storeRank", "admin:businessAttribute", "admin:businessCash", "admin:categoryApplication", "admin:businessDeposit"]]
				[#if hasPermission]
					<div class="panel-heading">
						<h4 class="panel-title">
							<a href="#mechanismGroupPanelCollapse" data-toggle="collapse" data-parent="#mainSidebarPanelGroup"[#if .main_template_name?matches("admin/mechanism/.*|admin/mechanism_store/.*")] aria-expanded="true"[/#if]>
								<i class="iconfont icon-shop"></i>
								<span>${message("admin.mainHeader.mechanismGroup")}</span>
								<i class="iconfont icon-unfold"></i>
							</a>
						</h4>
					</div>
				[/#if]
			[/@has_any_permissions_tag]
			<div id="mechanismGroupPanelCollapse" class="panel-collapse collapse[#if .main_template_name?matches("admin/mechanism/.*|admin/mechanism_store/.*")] in[/#if]">
				<div class="panel-body">
					<ul class="list-group">
						[@has_permission_tag permission="admin:business"]
							[#if hasPermission]
								<li class="list-group-item[#if .main_template_name?matches("admin/mechanism/.*")] active[/#if]">
									<a href="${base}/admin/mechanism/list">
										<i class="iconfont icon-weixuanzhong"></i>
										${message("admin.mainSidebar.mechanism")}
									</a>
								</li>
							[/#if]
						[/@has_permission_tag]
						[@has_permission_tag permission="admin:store"]
							[#if hasPermission]
								<li class="list-group-item[#if .main_template_name?matches("admin/mechanism_store/.*")] active[/#if]">
									<a href="${base}/admin/mechanism_store/list">
										<i class="iconfont icon-weixuanzhong"></i>
										${message("admin.mainSidebar.mechanismStore")}
									</a>
								</li>
							[/#if]
						[/@has_permission_tag]
		...
		<div class="panel panel-default">
			[@has_any_permissions_tag permissions = ["admin:product", "admin:stock", "admin:productCategory", "admin:productTag", "admin:parameter", "admin:attribute", "admin:specification", "admin:brand"]]
				[#if hasPermission]
					<div class="panel-heading">
						<h4 class="panel-title">
							<a href="#productGroupPanelCollapse" data-toggle="collapse" data-parent="#mainSidebarPanelGroup"[#if .main_template_name?matches("admin/product/.*|admin/product_fine/.*|admin/product_hot/.*|admin/new_launch/.*|admin/demandManagement/.*|admin/stock/.*|admin/product_category/.*|admin/product_tag/.*|admin/parameter/.*|admin/attribute/.*|admin/specification/.*|admin/brand/.*|admin/sample/.*")] aria-expanded="true"[/#if]>
				...
				[/#if]
			[/@has_any_permissions_tag]
			<div id="productGroupPanelCollapse" class="panel-collapse collapse[#if .main_template_name?matches("admin/product/.*|admin/product_fine/.*|admin/product_hot/.*|admin/new_launch/.*|admin/demandManagement/.*|admin/stock/.*|admin/product_category/.*|admin/product_tag/.*|admin/parameter/.*|admin/attribute/.*|admin/specification/.*|admin/brand/.*|admin/sample/.*")] in[/#if]">
				<div class="panel-body">
					<ul class="list-group">
						...
						[@has_permission_tag permission="admin:product"]
							[#if hasPermission]
								<li class="list-group-item[#if .main_template_name?matches("admin/sample/.*")] active[/#if]">
									<a href="${base}/admin/sample/list">
										<i class="iconfont icon-weixuanzhong"></i>
										索取样片管理
									</a>
								</li>
						...
						[@has_permission_tag permission="admin:product"]
							[#if hasPermission]
								<li class="list-group-item[#if .main_template_name?matches("admin/product_fine/.*")] active[/#if]">
									<a href="${base}/admin/product_fine/list">
										<i class="iconfont icon-weixuanzhong"></i>
										${message("admin.mainSidebar.productFine")}
									</a>
								</li>
							[/#if]
						[/@has_permission_tag]
						[#if false]
							[@has_permission_tag permission="admin:product"]
								[#if hasPermission]
									<li class="list-group-item[#if .main_template_name?matches("admin/product_hot/.*")] active[/#if]">
										<a href="${base}/admin/product_hot/list">
											<i class="iconfont icon-weixuanzhong"></i>
											${message("admin.mainSidebar.productHot")}
										</a>
									</li>
								[/#if]
							[/@has_permission_tag]
						...
						[@has_permission_tag permission="admin:article"]
								<li class="list-group-item[#if .main_template_name?matches("admin/new_launch/.*")] active[/#if]">
									<a href="${base}/admin/new_launch/list">
										<i class="iconfont icon-weixuanzhong"></i>
										${message("admin.mainSidebar.newlaunch")}
									</a>
								</li>
						[/@has_permission_tag]
						<!--集成电路产品需求管理-->
						[@has_permission_tag permission="admin:article"]
								<li class="list-group-item[#if .main_template_name?matches("admin/demandManagement/.*")] active[/#if]">
									<a href="${base}/admin/demand_management/list">
										<i class="iconfont icon-weixuanzhong"></i>
										${message("admin.mainSidebar.productNeed")}
									</a>
								</li>
						[/@has_permission_tag]
						[#if false]
		...
		<div class="panel panel-default">
			[@has_any_permissions_tag permissions = ["admin:member", "admin:memberRank", "admin:memberAttribute", "admin:point", "admin:memberDeposit", "admin:review", "admin:consultation", "admin:messageConfig", "admin:wechatMessageTemplate"]]
				[#if hasPermission]
					<div class="panel-heading">
						<h4 class="panel-title">
							<a href="#memberGroupPanelCollapse" data-toggle="collapse" data-parent="#mainSidebarPanelGroup"[#if .main_template_name?matches("admin/member/.*|admin/member_real/.*|admin/member_rank/.*|admin/member_attribute/.*|admin/point/.*|admin/member_deposit/.*|admin/review/.*|admin/consultation/.*|admin/message_config/.*|admin/wechat_message_template/.*")] aria-expanded="true"[/#if]>
				...
				[/#if]
			[/@has_any_permissions_tag]
			<div id="memberGroupPanelCollapse" class="panel-collapse collapse[#if .main_template_name?matches("admin/member/.*|admin/member_real/.*|admin/member_rank/.*|admin/member_attribute/.*|admin/point/.*|admin/member_deposit/.*|admin/review/.*|admin/consultation/.*|admin/message_config/.*|admin/wechat_message_template/.*")] in[/#if]">
				<div class="panel-body">
					<ul class="list-group">
						...
						[@has_permission_tag permission="admin:member"]
							[#if hasPermission]
								<li class="list-group-item[#if .main_template_name?matches("admin/member_real/.*")] active[/#if]">
									<a href="${base}/admin/member_real/list">
										<i class="iconfont icon-weixuanzhong"></i>
										${message("admin.mainSidebar.memberReal")}
									</a>
								</li>
							[/#if]
						[/@has_permission_tag]
		...
		<div class="panel panel-default">
			[@has_any_permissions_tag permissions = ["admin:navigationGroup", "admin:navigation", "admin:article", "admin:articleCategory", "admin:articleTag", "admin:friendLink", "admin:adPosition", "admin:ad", "admin:template", "admin:cache"]]
				[#if hasPermission]
					<div class="panel-heading">
						<h4 class="panel-title">
							<a href="#contentGroupPanelCollapse" data-toggle="collapse" data-parent="#mainSidebarPanelGroup"[#if .main_template_name?matches("admin/navigation_group/.*|admin/navigation/.*|admin/article/.*|admin/article_category/.*|admin/article_tag/.*|admin/wiki/.*|admin/wiki_category/.*|admin/wiki_tag/.*|admin/trainv/.*|admin/information/.*|admin/friend_link/.*|admin/ad_position/.*|admin/ad/.*|admin/template/.*|admin/cache/.*|admin/xm_navigation_group/.*|admin/xm_navigation/.*|admin/mechanism_article/.*")] aria-expanded="true"[/#if]>
				...
				[/#if]
			[/@has_any_permissions_tag]
			<div id="contentGroupPanelCollapse" class="panel-collapse collapse[#if .main_template_name?matches("admin/navigation_group/.*|admin/navigation/.*|admin/article/.*|admin/article_category/.*|admin/article_tag/.*|admin/wiki/.*|admin/wiki_category/.*|admin/wiki_tag/.*|admin/trainv/.*|admin/information/.*|admin/friend_link/.*|admin/ad_position/.*|admin/ad/.*|admin/template/.*|admin/cache/.*|admin/xm_navigation_group/.*|admin/xm_navigation/.*|admin/mechanism_article/.*")] in[/#if]">
				<div class="panel-body">
					<ul class="list-group">
						...
						[@has_permission_tag permission="admin:navigationGroup"]
							[#if hasPermission]
								<li class="list-group-item[#if .main_template_name?matches("admin/xm_navigation_group/.*")] active[/#if]">
									<a href="${base}/admin/xm_navigation_group/list">
										<i class="iconfont icon-weixuanzhong"></i>
										${message("admin.mainSidebar.xmnavigationGroup")}
									</a>
								</li>
							[/#if]
						[/@has_permission_tag]
						[@has_permission_tag permission="admin:navigation"]
							[#if hasPermission]
								<li class="list-group-item[#if .main_template_name?matches("admin/xm_navigation/.*")] active[/#if]">
									<a href="${base}/admin/xm_navigation/list">
										<i class="iconfont icon-weixuanzhong"></i>
										${message("admin.mainSidebar.xmnavigation")}
									</a>
								</li>
							[/#if]
						[/@has_permission_tag]
						...
						[@has_permission_tag permission="admin:article"]
							[#if hasPermission]
								<li class="list-group-item[#if .main_template_name?matches("admin/wiki/.*")] active[/#if]">
									<a href="${base}/admin/wiki/list">
										<i class="iconfont icon-weixuanzhong"></i>
										${message("admin.mainSidebar.wiki")}
									</a>
								</li>
							[/#if]
						[/@has_permission_tag]
						[@has_permission_tag permission="admin:articleCategory"]
							[#if hasPermission]
								<li class="list-group-item[#if .main_template_name?matches("admin/wiki_category/.*")] active[/#if]">
									<a href="${base}/admin/wiki_category/list">
										<i class="iconfont icon-weixuanzhong"></i>
										${message("admin.mainSidebar.wikiCategory")}
									</a>
								</li>
							[/#if]
						[/@has_permission_tag]
						[@has_permission_tag permission="admin:articleTag"]
							[#if hasPermission]
								<li class="list-group-item[#if .main_template_name?matches("admin/wiki_tag/.*")] active[/#if]">
									<a href="${base}/admin/wiki_tag/list">
										<i class="iconfont icon-weixuanzhong"></i>
										${message("admin.mainSidebar.wikiTag")}
									</a>
								</li>
							[/#if]
						[/@has_permission_tag]
						[@has_permission_tag permission="admin:article"]
							[#if hasPermission]
								<li class="list-group-item[#if .main_template_name?matches("admin/trainv/.*")] active[/#if]">
									<a href="${base}/admin/trainv/list">
										<i class="iconfont icon-weixuanzhong"></i>
										${message("admin.mainSidebar.trainv")}
									</a>
								</li>
							[/#if]
						[/@has_permission_tag]
						<!--芯梦观点-->
						[@has_permission_tag permission="admin:article"]
								<li class="list-group-item[#if .main_template_name?matches("admin/information/.*")] active[/#if]">
									<a href="${base}/admin/information/list">
										<i class="iconfont icon-weixuanzhong"></i>
										${message("admin.mainSidebar.information")}
									</a>
								</li>
						[/@has_permission_tag]
						[@has_permission_tag permission="admin:store"]
							[#if hasPermission]
								<li class="list-group-item[#if .main_template_name?matches("admin/mechanism_article/.*")] active[/#if]">
									<a href="${base}/admin/mechanism_article/list">
										<i class="iconfont icon-weixuanzhong"></i>
										${message("admin.mainSidebar.wz")}
									</a>
								</li>
							[/#if]
						[/@has_permission_tag]
