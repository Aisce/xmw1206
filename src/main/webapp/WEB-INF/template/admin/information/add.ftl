...
<head>
	...
	<title>${message("admin.information.add")} - 北京芯梦国际科技有限公司</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.information.add")}</li>
			</ol>
			<form id="articleForm" class="ajax-form form-horizontal" action="${base}/admin/information/save" method="post">
				<div class="panel panel-default">
					<div class="panel-heading">${message("admin.information.add")}</div>
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-4">
								...
								<textarea id="seoDescription" name="seoDescription" class="form-control" rows="8" ></textarea>
							</div>
						</div>
						<!--内容-->
						<div class="form-group">
