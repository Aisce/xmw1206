...
<head>
	...
	<title>${message("admin.article.list")} - 北京芯梦国际科技有限公司</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.information.list")}</li>
			</ol>
			<form action="${base}/admin/information/list" method="get">
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/admin/information/add" data-redirect-url="${base}/admin/article/list">
							...
							<table class="table table-hover">
								<thead>
									<tr>
										...
										<th>
											<a href="javascript:;" data-order-property="author">
										...
										<th>
											<a href="javascript:;" data-order-property="isPublication">
												${message("Information.isPublication")}
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
										<th>
								...
								[#if page.content?has_content]
									<tbody>
										[#list page.content as information]
											<tr>
												<td>
													<div class="checkbox">
														<input name="ids" type="checkbox" value="${information.id}">
														<label></label>
													</div>
												</td>
												...
												<td>
													<span title="${information.createdDate?string("yyyy-MM-dd HH:mm:ss")}" data-toggle="tooltip">${information.createdDate}</span>
												</td>
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/information/edit?id=${information.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
														<i class="iconfont icon-write"></i>
													</a>
													[#if information.isPublication]
														<a class="btn btn-default btn-xs btn-icon" href="${base}/information/detail?informationId=${information.id}" title="${message("common.view")}" data-toggle="tooltip" target="_blank">
															<i class="iconfont icon-search"></i>
														</a>
													[#else]
