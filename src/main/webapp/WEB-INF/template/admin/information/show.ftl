...
<head>
	...
	<title>${message("admin.information.show")} - 北京芯梦国际科技有限公司</title>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-4">
								<input id="author" name="author" readonly class="form-control" type="text" maxlength="200" value="${information.author}">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-4">
								<div class="checkbox checkbox-inline">
									...
									<input id="isPublication" name="isPublication" type="checkbox" value="true" value="true" disabled [#if information.isPublication] checked[/#if]>
									<label for="isPublication">${message("Information.isPublication")}</label>
								</div>
								<div class="checkbox checkbox-inline">
									<input name="_isTop" type="hidden" value="false">
									<input id="isTop" name="isTop" type="checkbox" value="true" disabled [#if information.isTop] checked[/#if]>
						...
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-4">
								...
								<textarea id="seoDescription" readonly name="seoDescription" class="form-control" row="4" >${information.seoDescription}</textarea>
							</div>
						</div>
						<!--内容-->
						<div class="form-group">
