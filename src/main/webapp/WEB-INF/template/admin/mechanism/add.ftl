...
<head>
	...
	<title>${message("admin.mechanism.add")} - 北京芯梦国际科技有限公司</title>
				...
				$businessForm.validate({
					rules: {
						username: {
							...
							notAllNumber: true,
							remote: {
								url: "${base}/admin/mechanism/check_name",
								cache: false
							}
						},
						password: {
						...
						email: {
							...
							email: true,
							remote: {
								url: "${base}/admin/mechanism/check_email",
								cache: false
							}
						},
						mobile: {
							...
							mobile: true,
							remote: {
								url: "${base}/admin/mechanism/check_phone",
								cache: false
							}
						}
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.mechanism.add")}</li>
			</ol>
			<form id="businessForm" class="ajax-form form-horizontal" action="${base}/admin/mechanism/save" method="post">
