...
<head>
	...
	<title>${message("admin.mechanism.edit")} - 北京芯梦国际科技有限公司</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.mechanism.edit")}</li>
			</ol>
			<form id="businessForm" class="ajax-form form-horizontal" action="${base}/admin/mechanism/update" method="post">
