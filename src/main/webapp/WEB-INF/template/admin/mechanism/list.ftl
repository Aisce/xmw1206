...
<head>
	...
	<title>${message("admin.mechanism.list")} - 北京芯梦国际科技有限公司</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.mechanism.list")}</li>
			</ol>
			<form action="${base}/admin/mechanism/list" method="get">
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/admin/mechanism/add" data-redirect-url="${base}/admin/mechanism/list">
									...
									<tbody>
										[#list page as mechanism]
											<tr>
												...
												<td>${mechanism.username}</td>
												<td>${mechanism.email}</td>
												<td>${mechanism.mobile}</td>
												<td>
													<span title="${mechanism.createdDate?string("yyyy-MM-dd HH:mm:ss")}" data-toggle="tooltip">${mechanism.createdDate}</span>
												</td>
												<td>
													[#if !mechanism.isEnabled]
														<span class="text-red">${message("admin.business.disabled")}</span>
													[#elseif mechanism.isLocked]
												...
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/mechanism/view?id=${mechanism.id}" title="${message("common.view")}" data-toggle="tooltip">
														<i class="iconfont icon-search"></i>
													</a>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/mechanism/edit?id=${mechanism.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
