					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									[#if false]
										<a class="btn btn-default" href="${base}/admin/mechanism_article/add" data-redirect-url="${base}/admin/mechanism_store/list">
									...
									<tbody>
										[#list page.content as store]
											<tr>
												...
												<td>${message("mechanismStore.Type." + store.type)}文章</td>
												<td>
													<span title="${store.createdDate?string("yyyy-MM-dd HH:mm:ss")}" data-toggle="tooltip">${store.createdDate}</span>
												</td>
												<td>
													<!--<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/mechanism_article/view?id=${store.id}" title="${message("common.view")}" data-toggle="tooltip">
														<i class="iconfont icon-search"></i>
													</a>-->
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/mechanism_article/edit?id=${store.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
