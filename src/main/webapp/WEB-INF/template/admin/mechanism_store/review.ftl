...
<head>
	...
	<title>${message("admin.store.review")} - 北京芯梦国际科技有限公司</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.mechanismStore.review")}</li>
			</ol>
			<form id="storeForm" class="ajax-form form-horizontal" action="${base}/admin/mechanism_store/review" method="post">
				<input name="id" type="hidden" value="${store.id}">
				<div class="panel panel-default">
					<div class="panel-body">
						<ul class="nav nav-tabs">
							<li class="active">
								<a href="#store" data-toggle="tab">${message("admin.mechanismStore.review")}</a>
							</li>
							<li>
								<a href="#business" data-toggle="tab">${message("mechanismStore.mainSidebar")}</a>
							</li>
						</ul>
						<div class="tab-content">
								...
								<div class="row">
									<div class="col-xs-12 col-sm-6">
										<dl class="items dl-horizontal">
											...
											<dd>${message("mechanismStore.Type." + store.type)}</dd>
							...
							<div id="business" class="tab-pane">
								...
								[/@business_attribute_list]
								<div class="form-group">
									<label class="col-xs-3 col-sm-2 control-label item-required">${message("admin.mechanismStore.mechanism")}:</label>
									<div class="col-xs-9 col-sm-4">
