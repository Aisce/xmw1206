...
<head>
	...
	<title>${message("admin.memberReal.list")} - 北京芯梦国际科技有限公司</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.memberReal.list")}</li>
			</ol>
									...
									<tbody>
										[#list page.content as member]
											<tr>
												...
												<td>
													[#if member.attestationFlag=='REALING']
														<span class="text-red">${message("admin.memberReal.realing")}</span>
													[/#if]
												</td>
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/member_real/edit?id=${member.id}" title="${message("admin.memberReal.real")}" data-toggle="tooltip" data-redirect-url>
