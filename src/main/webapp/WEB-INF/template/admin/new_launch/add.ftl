...
<head>
	...
	<title>${message("addmin.addNew")} - 北京芯梦国际科技有限公司</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("addmin.addNew")}</li>
			</ol>
			<form id="articleForm" class="ajax-form form-horizontal" action="${base}/admin/new_launch/save" method="post">
				<div class="panel panel-default">
					<div class="panel-heading">${message("addmin.addNew")}</div>
					<div class="panel-body">
						<div class="form-group">
						<!--产品名称-->
							<label class="col-xs-3 col-sm-2 control-label item-required" for="title">${message("admin.cpName")}:</label>
							<div class="col-xs-9 col-sm-4">
								<input id="title" name="name" class="form-control" type="text" maxlength="200">
							</div>
						</div>
						<div class="form-group">
						<!--型号规格-->
							...
							<div class="col-xs-9 col-sm-4">
								<input id="title" name="typeNorms" class="form-control" type="text" maxlength="200">
							</div>
						</div>
						<div class="form-group">
						<!--产品编号-->
							<label class="col-xs-3 col-sm-2 control-label item-required" for="title">${message("admin.productCode")}:</label>
							<div class="col-xs-9 col-sm-4">
								<select id="productsId" name="productsId" class="selectpicker form-control" data-size="10" title="${message("admin.product.title")}">
								</select>
							</div>
						</div>
						<div class="form-group">
						<!--生产厂商-->
							...
							<div class="col-xs-9 col-sm-4">
								<input id="title" name="unit" class="form-control" type="text" maxlength="200">
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label item-required">${message("addmin.Image")}:</label>
							<div class="col-xs-9 col-sm-4">
								<input id="img" name="img" type="hidden" data-provide="fileinput" data-file-type="IMAGE">
							</div>
						</div>
						...
						<!--质量等级-->
							...
							<div class="col-xs-9 col-sm-4">
								<input id="weight" name="weight" class="form-control" type="text" maxlength="200">
							</div>
						</div>
						<div class="form-group">
						<!--定型时间-->
							...
							<div class="col-xs-9 col-sm-4">
								<div class='input-group'>
									<input type='text' name="stereotypeTime" id="endTime" class="form-control" data-provide="datetimepicker" data-date-format="YYYY"/>
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-4">
								<div class="checkbox checkbox-inline">
									...
									<input id="isPublication" name="releaseFlag" type="checkbox" value="1" checked>
						...
						<!--生产厂商-->
							...
							<div class="col-xs-9 col-sm-4">
								<textarea id="synopsis" name="synopsis" class="form-control" type="text" maxlength="200" rows="8"></textarea>
							</div>
						</div>
						<div class="form-group">
