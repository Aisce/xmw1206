...
<head>
	...
	<title>${message("admin.mainSidebar.newlaunch")} - 北京芯梦国际科技有限公司</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.mainSidebar.newlaunch")}</li>
			</ol>
			<form action="${base}/admin/new_launch/list" method="get">
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/admin/new_launch/add" data-redirect-url="${base}/admin/new_launch/list">
									...
									<tr>
										...
										<th>
											<a href="javascript:;" data-order-property="name">
												${message("admin.cpName")}
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
										<th>
											<a href="javascript:;" data-order-property="unit">
												${message("admin.scfirm")}
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
										<th>
											<a href="javascript:;" data-order-property="productId">
												${message("admin.productCode")}
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
										<th>
											<a href="javascript:;" data-order-property="releaseFlag">
												${message("admin.isRelease")}
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
										<th>
											<a href="javascript:;" data-order-property="creatTime">
									...
									<tbody>
										[#list page.content as launch]
											<tr>
												...
												<td>${launch.name}</td>
												<td>${launch.unit}</td>
												<td>${launch.productId.name}</td>
												<td>
													[#if launch.releaseFlag == 1]
												...
												<td>
													<span title="${launch.creatTime?string("yyyy-MM-dd HH:mm:ss")}" data-toggle="tooltip">${launch.creatTime}</span>
												</td>
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/new_launch/edit?id=${launch.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
														<i class="iconfont icon-write"></i>
													</a>
													[#if launch.releaseFlag == 1]
														<a class="btn btn-default btn-xs btn-icon" href="${base}/new_launch/detail?launchId=${launch.id}" title="${message("common.view")}" data-toggle="tooltip" target="_blank" data-redirect-url>
															<i class="iconfont icon-search"></i>
														</a>
													[#else]
