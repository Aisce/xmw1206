...
<head>
	...
	<title>${message("admin.productCategory.edit")} - 北京芯梦国际科技有限公司</title>
			...
			<form id="productCategoryForm" class="ajax-form form-horizontal" action="${base}/admin/product_category/update" method="post">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label item-required" for="number">${message("ProductCategory.number")}:</label>
							<div class="col-xs-9 col-sm-4">
								<input id="number" name="number" class="form-control" type="text" value="${productCategory.number}" maxlength="6">
							</div>
						</div>
						<div class="form-group">
