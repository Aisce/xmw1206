	...
	[#noautoesc]
		[#escape x as x?js_string]
			...
			$().ready(function() {
				...
				var $cancelFine = $("#cancelFine");
				var $ids = $("input[name='ids']");
				
				// 删除
				$delete.on("success.shopxx.delete", function() {
					$cancelFine.attr("disabled", true);
				});
				
				// 取消优秀产品
				$cancelFine.click(function() {
					bootbox.confirm("${message("admin.product.cancelFineConfirm")}", function(result) {
						if (result == null || !result) {
							return;
						}
						
						$.post("${base}/admin/product_fine/cancel_fine", $("input[name='ids']").serialize(), function() {
				...
				// ID多选框
				$ids.change(function() {
					$cancelFine.attr("disabled", $("input[name='ids']:checked").length < 1);
				});
...
<body class="admin">
	...
	<main>
		<div class="container-fluid">
			...
			<form action="${base}/admin/product_fine/list" method="get">
						...
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									...
									<button id="cancelFine" class="btn btn-default" type="button" data-toggle="shelf" disabled>
										<i class="iconfont icon-moreunfold"></i>
										${message("admin.product.cancelFine")}
									</button>
									<div class="btn-group">
