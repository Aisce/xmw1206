...
<head>
	...
	<title>${message("admin.order.list")} - 北京芯梦国际科技有限公司</title>
...
<body class="admin">
	...
	<main>
		<div class="container-fluid">
			...
			<form action="${base}/admin/sample/list" method="get">
							...
							<div class="col-xs-12 col-sm-3">
								<div id="search" class="input-group">
									<div class="input-group-btn">
										...
										<ul class="dropdown-menu">
											<li[#if page.searchProperty == "applyCompany"] class="active"[/#if] data-search-property="applyCompany">
									...
									<tr>
										<th>
											<a href="javascript:;" data-order-property="applyUser">
												${message("admin.sample.sqr")}
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
										<th>
											<a href="javascript:;" data-order-property="applyCompany">
												${message("admin.sample.sqdw")}
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
										<th>
											<a href="javascript:;" data-order-property="sampleNumber">
												${message("admin.sample.ypsl")}
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
										<th>
											<a href="javascript:;" data-order-property="phone">
												${message("admin.sample.phone")}
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
										<th>
											<a href="javascript:;" >
												${message("admin.sample.product.name")}
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
										<th>
									...
									<tbody>
										[#list page.content as sample]
											<tr>
												...
												<td>${sample.applyCompany}</td>
												<td>${sample.sampleNumber}</td>
												<td>${sample.phone}</td>
												<td>${sample.product.name}</td>
												[#if sample.flag == '1']
													<td>审核通过</td>
												[#elseif sample.flag == '2']
													<td>审核不通过</td>
												[#else]
													<td>审核中</td>
												[/#if]
												...
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/sample/view?id=${sample.id}" title="${message("common.view")}" data-toggle="tooltip">
														<i class="iconfont icon-search"></i>
													</a>
												</td>
											</tr>
