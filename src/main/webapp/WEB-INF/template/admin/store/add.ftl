...
<head>
	...
	<title>${message("admin.store.add")} - 北京芯梦国际科技有限公司</title>
			...
			<form id="storeForm" class="ajax-form form-horizontal" action="${base}/admin/store/save" method="post">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label item-required" for="number">${message("Store.number")}:</label>
							<div class="col-xs-9 col-sm-4">
						...
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-4">
								<input id="sclxr" name="sclxr" class="form-control" type="text" maxlength="16">
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label" for="sclxfs">${message("Store.sclxfs")}:</label>
							<div class="col-xs-9 col-sm-4">
								<input id="sclxfs" name="sclxfs" class="form-control" type="text" maxlength="16">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-4">
								...
								<div class="checkbox">
									<input name="_isFine" type="hidden" value="false">
									<input id="isFine" name="isFine" type="checkbox" value="true" checked>
									<label for="isFine">${message("Store.isFine")}</label>
								</div>
							</div>
						</div>
					</div>
