...
<head>
	...
	<title>${message("admin.store.list")} - 北京芯梦国际科技有限公司</title>
		...
		[#escape x as x?js_string]
			...
			$().ready(function() {
				...
				$setFine.click(function() {
					bootbox.confirm("${message("admin.store.setFineConfirm")}", function(result) {
						if (result == null || !result) {
							return;
						}
						
						$.post("${base}/admin/store_fine/set_fine", $("input[name='ids']").serialize(), function() {
									...
									<div class="btn-group">
										...
										<ul class="dropdown-menu">
											<li[#if isFine?? && isFine] class="active"[/#if] data-filter-property="isFine" data-filter-value="true">
												<a href="javascript:;">${message("admin.store.isFine")}</a>
											</li>
											<li[#if isFine?? && !isFine] class="active"[/#if] data-filter-property="isFine" data-filter-value="false">
												<a href="javascript:;">${message("admin.store.notFine")}</a>
											</li>
											<li class="divider"></li>
