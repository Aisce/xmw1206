		...
		[#escape x as x?js_string]
			...
			$().ready(function() {
				...
				$cancelFine.click(function() {
					bootbox.confirm("${message("admin.store.cancelFineConfirm")}", function(result) {
						if (result == null || !result) {
							return;
						}
						
						$.post("${base}/admin/store_fine/cancel_fine", $("input[name='ids']").serialize(), function() {
						...
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									...
									<button id="cancelFine" class="btn btn-default" type="button" data-toggle="cancelFine" disabled>
										<i class="iconfont icon-moreunfold"></i>
										${message("admin.store.cancelFine")}
									</button>
									<div class="btn-group">
