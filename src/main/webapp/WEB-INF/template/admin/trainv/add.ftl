...
<head>
	...
	<title>${message("admin.trainv.add")} - 北京芯梦国际科技有限公司</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.trainv.add")}</li>
			</ol>
			<form id="trainvForm" class="ajax-form form-horizontal" action="${base}/admin/trainv/save" method="post">
				<div class="panel panel-default">
					<div class="panel-heading">${message("admin.trainv.add")}</div>
					<div class="panel-body">
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label item-required" for="title">${message("Trainv.subject")}:</label>
							<div class="col-xs-9 col-sm-4">
								<input id="subject" name="subject" class="form-control" type="text" maxlength="200">
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label" for="sponsor">${message("Trainv.sponsor")}:</label>
							<div class="col-xs-9 col-sm-4">
								<input id="sponsor" name="sponsor" class="form-control" type="text" maxlength="200">
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label" for="sponsor">${message("Trainv.address")}:</label>
							<div class="col-xs-9 col-sm-4">
						...
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-4">
								<div class="input-group" data-provide="datetimerangepicker" data-date-format="YYYY-MM-DD">
									<input id="bmStartDate" name="bmStartDate" class="form-control" type="text">
									<span class="input-group-addon">-</span>
									<input name="bmEndDate" class="form-control" type="text">
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-4">
								<div class="input-group" data-provide="datetimerangepicker" data-date-format="YYYY-MM-DD">
									<input id="pxStartDate" name="pxStartDate" class="form-control" type="text">
									<span class="input-group-addon">-</span>
									<input name="pxEndDate" class="form-control" type="text">
								</div>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-10">
								<textarea id="synopsis" name="synopsis" class="form-control" rows="8"></textarea>
							</div>
						</div>
						<div class="form-group">
