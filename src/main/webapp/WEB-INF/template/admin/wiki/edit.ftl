...
<head>
	...
	<title>${message("admin.wiki.edit")} - 北京芯梦国际科技有限公司</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.wiki.edit")}</li>
			</ol>
			<form id="wikiForm" class="ajax-form form-horizontal" action="${base}/admin/wiki/update" method="post">
				<input name="id" type="hidden" value="${wiki.id}">
				<div class="panel panel-default">
					<div class="panel-heading">${message("admin.wiki.edit")}</div>
					<div class="panel-body">
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label item-required" for="title">${message("Wiki.title")}:</label>
							<div class="col-xs-9 col-sm-4">
								<input id="title" name="title" class="form-control" type="text" value="${wiki.title}" maxlength="200">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-4">
								<select name="wikiCategoryId" class="selectpicker form-control" data-size="10">
									[#list wikiCategoryTree as wikiCategory]
										<option value="${wikiCategory.id}" title="${wikiCategory.name}"[#if wikiCategory.id == wiki.wikiCategory.id] selected[/#if]>
						...
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-4">
								<input id="author" name="author" class="form-control" type="text" value="${wiki.author}" maxlength="200">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-4">
								<div class="checkbox checkbox-inline">
									...
									<input id="isPublication" name="isPublication" type="checkbox" value="true"[#if wiki.isPublication] checked[/#if]>
									<label for="isPublication">${message("Wiki.isPublication")}</label>
								</div>
								<div class="checkbox checkbox-inline">
									<input name="_isTop" type="hidden" value="false">
									<input id="isTop" name="isTop" type="checkbox" value="true"[#if wiki.isTop] checked[/#if]>
						...
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-10">
								[#list wikiTags as wikiTag]
									<div class="checkbox checkbox-inline">
										<input id="wikiTag_${wikiTag.id}" name="wikiTagIds" type="checkbox" value="${wikiTag.id}"[#if wiki.wikiTags?seq_contains(wikiTag)] checked[/#if]>
						...
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-10">
								...
								<textarea name="content" style="display:none;" id="ueditorHtml">${wiki.content}</textarea>
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label" for="seoTitle">${message("Wiki.seoTitle")}:</label>
							<div class="col-xs-9 col-sm-4">
								<input id="seoTitle" name="seoTitle" class="form-control" type="text" value="${wiki.seoTitle}" maxlength="200">
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label" for="seoKeywords">${message("Wiki.seoKeywords")}:</label>
							<div class="col-xs-9 col-sm-4">
								<input id="seoKeywords" name="seoKeywords" class="form-control" type="text" value="${wiki.seoKeywords}" maxlength="200">
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label" for="seoDescription">${message("Wiki.seoDescription")}:</label>
							<div class="col-xs-9 col-sm-4">
								<input id="seoDescription" name="seoDescription" class="form-control" type="text" value="${wiki.seoDescription}" maxlength="200">
							</div>
						</div>
					</div>
