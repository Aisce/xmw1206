...
<head>
	...
	<title>${message("admin.wikiTag.list")} - 北京芯梦国际科技有限公司</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.wikiTag.list")}</li>
			</ol>
			<form action="${base}/admin/wiki_tag/list" method="get">
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/admin/wiki_tag/add" data-redirect-url="${base}/admin/wiki_tag/list">
						...
						<div class="table-responsive">
							<table class="table table-hover">
								...
								[#if page.content?has_content]
									<tbody>
										[#list page.content as wikiTag]
											<tr>
												<td>
													<div class="checkbox">
														<input name="ids" type="checkbox" value="${wikiTag.id}">
														<label></label>
													</div>
												</td>
												<td>${wikiTag.name}</td>
												<td>
													<span title="${wikiTag.createdDate?string("yyyy-MM-dd HH:mm:ss")}" data-toggle="tooltip">${wikiTag.createdDate}</span>
												</td>
												<td>${wikiTag.order}</td>
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/wiki_tag/edit?id=${wikiTag.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
