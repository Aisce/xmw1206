	...
	[#noautoesc]
		[#escape x as x?js_string]
			...
			$().ready(function() {
				...
				var $xmnavigationForm = $("#xmnavigationForm");
				...
				$xmnavigationForm.validate({
					...
					submitHandler: function(form) {
						$(form).ajaxSubmit({
							successRedirectUrl: "${base}/admin/xm_navigation/list"
						});
					}
				});
...
<body class="admin">
	...
	<main>
		<div class="container-fluid">
			...
			<form id="xmnavigationForm" class="ajax-form form-horizontal" action="${base}/admin/xm_navigation/save" method="post">
