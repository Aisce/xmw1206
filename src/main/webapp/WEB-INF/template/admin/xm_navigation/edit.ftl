...
<head>
	...
	<title>${message("admin.navigation.edit")} - 北京芯梦国际科技有限公司</title>
...
<body class="admin">
	...
	<main>
		<div class="container-fluid">
			...
			<form id="navigationForm" class="ajax-form form-horizontal" action="${base}/admin/xm_navigation/update" method="post">
