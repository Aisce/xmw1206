...
<head>
	...
	<title>${message("admin.navigation.list")} - 北京芯梦国际科技有限公司</title>
...
<body class="admin">
	...
	<main>
		<div class="container-fluid">
			...
			<form action="${base}/admin/xm_navigation/list" method="get">
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/admin/xm_navigation/add" data-redirect-url="${base}/admin/navigation/list">
									...
									<tbody>
										[#list page.content as navigation]
											<tr>
												...
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/xm_navigation/edit?id=${navigation.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
