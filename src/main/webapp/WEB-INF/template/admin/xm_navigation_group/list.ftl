...
<head>
	...
	<title>${message("admin.navigationGroup.list")} - 北京芯梦国际科技有限公司</title>
...
<body class="admin">
	...
	<main>
		<div class="container-fluid">
			...
			<form action="${base}/admin/xm_navigation_group/list" method="get">
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/admin/xm_navigation_group/add" data-redirect-url="${base}/admin/navigation_group/list">
							...
							<table class="table table-hover">
								<thead>
									<tr>
										...
										<th>
											<a href="javascript:;" data-order-property="paixu">
												排序
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
								...
								<tbody>
									[#list page.content as navigationGroup]
										<tr>
											...
											<td>${navigationGroup.paixu}</td>
											<td>
												<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/xm_navigation_group/edit?id=${navigationGroup.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
