		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4 class="panel-title">
					<a href="#productPanelCollapse" data-toggle="collapse" data-parent="#mainSidebarPanelGroup"[#if .main_template_name?matches("business/index.*|business/product/.*|business/stock/.*|business/product_notify/.*|business/consultation/.*|business/import/.*|business/sample/.*")] aria-expanded="true"[/#if]>
			...
			<div id="productPanelCollapse" class="panel-collapse collapse[#if .main_template_name?matches("business/index.*|business/product/.*|business/stock/.*|business/product_notify/.*|business/consultation/.*|business/import/.*|business/sample/.*")] in[/#if]">
				<div class="panel-body">
					<ul class="list-group">
						...
						<li class="list-group-item[#if .main_template_name?matches("business/import/.*")] active[/#if]">
							<a href="${base}/business/import/importPage">
								<i class="iconfont icon-weixuanzhong"></i>
								${message("business.mainSidebar.importExcel")}
							</a>
						</li>
						<li class="list-group-item[#if .main_template_name?matches("business/sample/.*")] active[/#if]">
							<a href="${base}/business/sample/list">
								<i class="iconfont icon-weixuanzhong"></i>
								${message("business.sample")}
							</a>
						</li>
