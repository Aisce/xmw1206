...
<head>
	...
	<title>${message("business.moneyOffPromotionPlugin.edit")} - 北京芯梦国际科技有限公司</title>
			...
			$().ready(function() {
				...
				$moneyOffPromotionForm.validate({
					...
					submitHandler: function(form) {
						...
						$(form).ajaxSubmit({
							successRedirectUrl: "${base}/business/money_off_promotion/list"
						});
					}
				});
				if (UE != null) {
					...
					<div class="panel-body">
						...
						<div class="tab-content">
							...
							<div id="introduction" class="tab-pane">
								...
								<textarea name="introduction" style="display:none;" id="ueditorHtml">${promotion.introduction}</textarea>
							</div>
						</div>
					</div>
