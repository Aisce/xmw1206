...
<head>
	...
	<title>${message("business.product.list")} - 北京芯梦国际科技有限公司</title>
										...
										[#list page.content as product]
											<tr>
												...
												<td>
													...
													[/#if]
													[#if !product.istjverify]
														<a class="btn btn-default btn-xs btn-icon" href="${base}/business/product/review?id=${product.id}" title="${message("business.product.review")}" data-toggle="tooltip" data-redirect-url>
