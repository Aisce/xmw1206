				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-4">
								<select id="mechanismId" name="mechanismId" class="form-control" title="${message("admin.mechanismStore.mechanismTitle")}">
									[#list jcList as jc]
					...
					<div class="panel-body">
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-4">
								<select id="bzmechanismId" name="bzmechanismId" class="form-control" title="${message("admin.mechanismStore.mechanismTitle")}">
									[#list bzList as bz]
										<option value="${bz.id}">${bz.name}</option>
									[/#list]
								</select>
							</div>
						</div>
