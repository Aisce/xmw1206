...
<head>
	...
	<title>${message("business.store.register")} - 北京芯梦国际科技有限公司</title>
	...
	[#noautoesc]
		[#escape x as x?js_string]
			...
			function createCode(){
			//获取分类id
			var storeCategoryId = $("#storeCategory").val();
				$.ajax({
					url : '${base}/business/store/create_code',
					type: 'post',
					dataType: 'json',
					data: {
						...
						<div class="tab-content">
							<div id="info" class="tab-pane active">
								...
								<div class="form-group[#if !storeCategories??] hidden-element[/#if]">
									...
									<div class="col-xs-9 col-sm-4">
										<select id="storeCategory" name="storeCategoryId" class="selectpicker form-control" data-live-search="true" data-size="10"  onchange="createCode()">
								...
								<!--店铺编号-->
								<div class="form-group">
									<label class="col-xs-3 col-sm-2 control-label item-required" for="name">${message("Store.number")}:</label>
									<div class="col-xs-9 col-sm-4">
										<input id="number" name="number" class="form-control" type="text" maxlength="6" readonly>
									</div>
								</div>
