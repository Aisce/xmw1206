...
<head>
	...
	<title>${message("business.store.setting")} - 北京芯梦国际科技有限公司</title>
			...
			<form id="storeForm" class="ajax-form form-horizontal" action="${base}/business/store/setting" method="post">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label">${message("Store.number")}:</label>
							<div class="col-xs-9 col-sm-4">
								<p class="form-control-static">${currentStore.number}</p>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-4">
								<input id="sclxr" name="sclxr" class="form-control" type="text" value="${currentStore.sclxr}" maxlength="16">
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label" for="sclxfs">${message("Store.sclxfs")}:</label>
							<div class="col-xs-9 col-sm-4">
								<input id="sclxfs" name="sclxfs" class="form-control" type="text" value="${currentStore.sclxfs}" maxlength="16">
							</div>
						</div>
						<div class="form-group">
