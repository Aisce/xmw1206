<div class="main-menu">
	...
	<div class="main-menu-body">
		<dl>
			...
			<dd[#if .main_template_name?matches(".*/sample/.*")] class="active"[/#if]>
				<a href="${base}/member/sample/list">${message("member.mainMenu.sample")}</a>
			</dd>
		...
		<dl>
			...
			<dd[#if .main_template_name?matches(".*/realname/.*")] class="active"[/#if]>
				<a href="${base}/member/realname/edit">${message("member.mainMenu.realnameEdit")}</a>
			</dd>
		...
		[#if false]
			...
			[/#if]
		[/#if]
		[#if currentUser.type == 'MECHANISM']
			[#if storeId.type == 'STANDARDIZATION']
				<dl>
					<dt>
						<i class="iconfont icon-friend"></i>
						${message("member.mainMenu.MECHANISM")}
					</dt>
					<dd[#if .main_template_name?matches("/product/.*")] class="active"[/#if]>
						<a href="${base}/product/standard_company">标准化机构认证</a>
					</dd>
				</dl>
			[/#if]
			[#if storeId.type == 'CHECK']
				<dl>
					<dt>
						<i class="iconfont icon-friend"></i>
						${message("member.mainMenu.MECHANISM")}
					...
					<dd[#if .main_template_name?matches("/product/.*")] class="active"[/#if]>
						<a href="${base}/product/check_company">检测机构认证</a>
					</dd>
				</dl>
			[/#if]
		[/#if]
