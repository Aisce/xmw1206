...
<head>
	...
	<title>${message("member.index.title")}[#if showPowered] - 北京芯梦国际科技有限公司[/#if]</title>
	...
	<main>
		<div class="container-fluid">
				...
				[#if navigations?has_content]
					[#list navigations as navigation]
						<div class="list-group">
							<div class="list-group-item">
								${navigation.name}
								<a class="pull-right text-gray" href="${navigation.url}" >
									${navigation.name}
									<i class="iconfont icon-right"></i>
								</a>
							</div>
			...
			<div class="list-group">
				<div class="list-group-item">
					辅助采购
					<a class="pull-right text-gray" href="${base}/shop/mechanism_store/purchase_page">
						辅助采购
						<i class="iconfont icon-right"></i>
					</a>
				</div>
