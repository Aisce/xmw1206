...
<head>
	...
	[@seo type = "ARTICLE_LIST"]
		...
		[/#if]
		<title>集成电路需求详情 - 北京芯梦国际科技有限公司</title>
	[/@seo]
	...
	<link href="${base}/resources/mobile/shop/demand_management/detail.less" type="text/css" rel="stylesheet/less">
	<!--[if lt IE 9]>
...
<body class="shop article-list">
	...
	<main>
		<div class="container" style="height: 646px;overflow: hidden; overflow-y: scroll;">
			<div id="listContent">
			<div class="list">
				<div id="needForm">
