...
<head>
	...
	<link href="${base}/resources/mobile/shop/css/reset.css" rel="stylesheet">
	<link href="${base}/resources/mobile/shop/css/listContent.css" rel="stylesheet">
	<link href="${base}/resources/mobile/shop/mechanism_store/check_list.less" type="text/css" rel="stylesheet/less">
	<!--[if lt IE 9]>
...
<body class="shop article-list">
	...
	<main>
		<div class="container">
				<div class="bzhjg" style="height: 812px;">
				<div class="title" style="font-size:17px">检测机构</div>
				<div class="content">
					[#noautoesc]
						${search.content}
					[/#noautoesc]
				</div>
				<div class="tips" style="margin-bottom: 53px;">
					[#if page.content?has_content]
						[#list page.content as mechanism]
							<a href="${base}/shop/mechanism_store/checkPage?id=${mechanism.id}"><span style="font-size:12px;margin-top: 11px;overflow: hidden;white-space: nowrap;text-overflow: ellipsis; width: 100%">${mechanism.name}</span></a>
						[/#list]					
					[/#if]
				</div>
			</div>
