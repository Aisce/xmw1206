...
<head>
	...
	<link href="${base}/resources/mobile/shop/mechanism_store/list.less" type="text/css" rel="stylesheet/less">
	<!--[if lt IE 9]>
...
<body class="shop article-list">
	...
	<main>
		<div class="container">
			<div class="bzhjg">
				<div class="title" style="font-size:16px">标准化机构</div>
				<div class="content">
					[#noautoesc]
						${search.content}
					[/#noautoesc]
				...
				<div class="tips" style="margin-bottom: 53px;">
					[#if page.content?has_content]
						[#list page.content as mechanism]
							<a href="${base}/shop/mechanism_store/bzh_page?id=${mechanism.id}"><span style="font-size:14px;margin-top: 11px;">${mechanism.name}</span></a>
						[/#list]					
					[/#if]
				</div>
			</div>
