...
<head>
	...
	<link href="${base}/resources/mobile/shop/mechanism_store/purchase_page.less" type="text/css" rel="stylesheet/less">
	<!--[if lt IE 9]>
...
<body class="shop article-list">
	...
	<main>
		...
		<div class="container">
			<div class="bzhjg">
				<div class="title" style="font-size:17px">辅助采购</div>
				<div class="content">
					[#noautoesc]
						${search.content}
					[/#noautoesc]
