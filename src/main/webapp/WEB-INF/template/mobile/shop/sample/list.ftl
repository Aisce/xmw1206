...
<head>
	...
	<link href="${base}/resources/mobile/shop/sample/list.less" type="text/css" rel="stylesheet/less">
	<!--[if lt IE 9]>
					...
					[#if page.content?has_content]
						[#list page.content as sample]
							<div class="body">
								<span>
									<div>
										<a href="${base}/product/detail/${sample.id}"><p style="width: 97px; white-space: nowrap; text-overflow: ellipsis;overflow: hidden;">${sample.name}</p></a>
