<script id="mainHeaderMemberInfoTemplate" type="text/template">
	...
	<%} else {%>
		<ul class="list-inline">
			...
			<li>
				<a href="${base}/business/index">厂家后台</a>
			</li>
		</ul>
	<%}%>
</script>
...
<header class="main-header">
	...
	<div class="top-nav">
		<div class="container">
			<div class="row">
				<div class="col-xs-12">
			   	      <div id="mainHeaderMemberInfo" class="pull-right"></div>
							...
							[#if navigations?has_content]
								[#list navigations as navigation]
									<li[#if navigation.url == requestContext.requestUri] class="active"[/#if]>
										<a style='padding:0 40px' href="${navigation.url}"[#if navigation.isBlankTarget] target="_blank"[/#if]>${navigation.name}</a>
									</li>
								[/#list]
							[/#if]
						[/@navigation_list]
