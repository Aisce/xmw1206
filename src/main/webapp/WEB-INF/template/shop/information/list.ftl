...
<body class="shop article-list">
	...
	<main>
		...
		<div class="container">
			...
			<div class="list">
				<form action="${base}/information/list" method="get" id="rform">
					<div class="search">
						<span>
						...
						<span>
							<img src="${base}/resources/shop/images/search.png"/>
							<input type="text" name="author" placeholder="请输入发布者" />
						</span>
				...
				<ul>
					[#list page.content as information]
						<a href="${base}/information/detail?informationId=${information.id}" style="text-decoration: none;">
							<li>
								<div>
				...
				[/#if]
				[@pagination pageNumber = page.pageNumber totalPages = page.totalPages pattern = "${base}/information/list[#if {pageNumber} > 1]?pageNumber={pageNumber}[/#if]"]
						[#if totalPages > 1]
