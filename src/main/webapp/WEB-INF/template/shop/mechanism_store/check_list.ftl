...
<head>
	...
	<link href="${base}/resources/shop/mechanism_store/check_list.less" type="text/css" rel="stylesheet/less">
	<!--[if lt IE 9]>
				...
				<div class="tips">
					[#if page.content?has_content]
						[#list page.content as mechanism]
							<a href="${base}/shop/mechanism_store/checkPage?id=${mechanism.id}" style="padding-left: 17px;"><span style="font-size:17px;margin-top: 11px;">${mechanism.name}</span></a>
						[/#list]					
					[/#if]
				</div>
			</div>
