...
<head>
	...
	<link href="${base}/resources/shop/mechanism_store/check_page.less" type="text/css" rel="stylesheet/less">
	<!--[if lt IE 9]>
			...
			<div class="row">
				...
				<div class="col-xs-10" style="width: 100%;">
					<ol class="breadcrumb">
						...
						<li >
							<a href="${base}/shop/mechanism_store/check_list">
								检测机构
							</a>
						</li>
				...
				<div class="bzhjg">
				<div class="title" style="font-size:17px">检测机构/${page.name}</div>
				<div class="content">
					[#noautoesc]
						${page.content}
					[/#noautoesc]
