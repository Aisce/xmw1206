...
<head>
	...
	<link href="${base}/resources/shop/mechanism_store/list.less" type="text/css" rel="stylesheet/less">
	<!--[if lt IE 9]>
			...
			<div class="row">
				...
				<div class="col-xs-10" style="width: 100%;">
					<ol class="breadcrumb">
						...
						<li class="active">标准化机构</li>
					</ol>
				</div>
			</div>
				<div class="bzhjg">
				<div class="title" style="font-size:17px">标准化机构</div>
				<div class="content">
					[#noautoesc]
						${search.content}
					[/#noautoesc]
				...
				<div class="tips">
					[#if page.content?has_content]
						[#list page.content as mechanism]
							<a href="${base}/shop/mechanism_store/bzh_page?id=${mechanism.id}" style="padding-left: 17px;"><span style="font-size:17px;margin-top: 11px;">${mechanism.name}</span></a>
						[/#list]					
					[/#if]
				</div>
			</div>
